...
function snap(ts: number, endpoints: InferenceEndpoint[]): ClusterSnapshot {
  ...
  return {
    ...
    totals: { nodes: 1, nodesOnline: 1, gpus: 0, vramTotalBytes: 0, vramUsedBytes: 0, cpuCores: 0, cpuUsagePct: 0,
      ...
      inferenceEndpoints: endpoints.length, tokensPerSec: 0, promptTokensPerSec: 0, promptComputedTokensPerSec: 0, generationTokensTotal: 0, promptTokensTotal: 0, cachedPromptTokensTotal: 0, requestsRunning: 0, requestsWaiting: 0 },
  };
}
